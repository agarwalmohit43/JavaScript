...
// console.log(arr2.fill("Yoo",1,5));//replace the character and fill with the value passed from index position to real position.
...
// console.log(arr.splice(1,4,"d"));//splice(start,end,inserting)
