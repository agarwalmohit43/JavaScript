...
let doublePrice = Object.fromEntries(Object.entries(prices).map(([key, value]) => [key, value *2] ));
...
let discountedPrice = Object.fromEntries(Object.entries(mobilePrice).map(([key, value]) => [key, value * .85]));
